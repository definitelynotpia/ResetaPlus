  ...
  Future<void> loginUser(BuildContext context) async {
    ...
    try {
      ...
      var result = await conn.execute('''
        SELECT a.pharmacy_id, a.*, k.encryption_key, k.initialization_vector 
        FROM reseta_plus.pharmacy_accounts a
        JOIN reseta_plus.pharmacy_account_keys k ON a.pharmacy_id = k.pharmacy_key_id
        WHERE a.email = :email
      ''', {'email': _email});
